export const SITE_METADATA = {
  ...
  alternateNames: [
    "Clement IfeOluwa",
    "ICEPAB",
    "IfeOluwa Clement Precious Abayomi Banmeke"
  ],
  ...
  url: "https://icepab.name.ng",
  social: {
    x: {
      handle: "@clementife12500",
      url: "https://x.com/clementife12500",
    },
    linkedin: {
      handle: "banmeke-ifeoluwa",
      url: "https://linkedin.com/in/banmeke-ifeoluwa",
    },
    github: {
      handle: "Clement-20",
